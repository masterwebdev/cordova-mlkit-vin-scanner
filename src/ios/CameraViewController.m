    ...
    */
    ...
    [self.barcodeDetector detectInImage:image
                    completion:^(NSArray<FIRVisionBarcode *> *barcodes,
                                 NSError *error) {
      if (error != nil) {
         //image = [self rotateImage:image toOrientation:UIImageOrientationRight];
    ...
    //NSArray<FIRVisionBarcode *> *barcodes = [self.barcodeDetector featuresInImage:image
    //                                                                       options:nil];
...
- (void)setUpCameraPreview {
    ...
    //NSLog(@"SCREEN WIDTH, HEIGHT %f, %f", screenWidth, screenHeight);
    
    //CGFloat frameWidth = screenWidth*_scanAreaWidth;
    //CGFloat frameHeight = screenHeight*_scanAreaHeight;
    CGFloat frameWidth = screenWidth*0.9;
    CGFloat frameHeight = screenHeight*0.4;
    
    //NSLog(@"FRAME WIDTH, HEIGHT %f, %f", frameWidth, frameHeight);
    
    //NSLog(@"FRAME %f, %f", screenWidth/2 - frameWidth/2, screenWidth/2 - frameWidth/2);
...
- (UIImage *)croppIngimageByImageName:(UIImage *)imageToCrop toRect:(CGRect)rect
{
    ...
    //NSLog(@"croppIngimageByImageName");
