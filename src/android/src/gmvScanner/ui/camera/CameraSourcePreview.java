...
public class CameraSourcePreview extends ViewGroup {
    ...
    public double ViewFinderWidth = .9;
    ...
    protected void onLayout(boolean changed, int left, int top, int right, int bottom) {
        ...
        double ir=width*1.0/height*1.0;
        double sr=layoutWidth*1.0/layoutHeight*1.0;
        double wr=width*1.0/layoutWidth*1.0;
        double hr=height*1.0/layoutHeight*1.0;
        ...
        if(wr!=hr){
            if(wr>hr){
                leftOffset = -1 * (layoutWidth - lwidth) / 2;
                lwidth=(int) (width/hr);
            }else {
                topOffset = -1 * (layoutHeight - lheight) / 2;
                lheight=(int) (height/wr);
            }
        }

        //mSurfaceView.layout(leftOffset, topOffset, childWidth, childHeight);
        mSurfaceView.layout(leftOffset, topOffset, lwidth, lheight);
